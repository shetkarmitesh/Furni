...
from .models import furniture,Team_Members,Cart_Item,ContactUs,ShopDetails,CustomUser,Orders
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('first_name', 'last_name', 'email', 'birth_date','phoneNo','subscriberOfNewsletter')}),
